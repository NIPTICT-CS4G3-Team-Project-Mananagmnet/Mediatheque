...
@section('content')
    ...
    <div class="container">
        ...
        <form action="/upload_single" method="POST" enctype="multipart/form-data" id="upload_single_form" onclick="clear()">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="input1" name="album">
            </div>

            <div class="form-group">
                <label for="input2">Name</label>
                <input type="text" class="form-control" id="input1" name="name_pic">
            </div>

            <div class="form-group">
                <label for="inputDate">Date</label>
                <input type="date" max="3000-12-31" 
                       min="1000-01-01" class="form-control" id="inputDate" name="date">
            </div>
            
            <div class="form-group">
                <label for="input3">Description</label>
                <input type="text" class="form-control" id="input3" name="des">
            </div>

            <div class="form-group">
                <label for="input4">Image File</label>
                <input type="file" class="form-control" id="input4" name="image" onchange="showImage.call(this)">
                <img src="" alt="" style="display:none; height:200px; margin-top:10px;" id="img">
            </div>
