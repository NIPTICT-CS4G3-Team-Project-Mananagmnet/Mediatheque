    ...
    $.fn.uploader = function (options, testMode) {
        return this.each(function (index) {
            options = $.extend({
                ...
                selectButtonCopy: 'Select Photos',
                secondarySelectButtonCopy: 'Select More Photos',
                dropZone: $(this),
                fileTypeWhiteList: ['jpg', 'png', 'jpeg', 'gif'],
                badFileTypeMessage: 'Sorry, we\'re unable to accept this type of file.',
                ajaxUrl: '/admin/upload_multiple_pictures',
                testMode: false
            }, options);
            ...
            var dom = {
                ...
                selectButton: $('<input style="height: 0; width: 0;" id="fileinput' + index + '" type="file" multiple accept=".jpeg,.jpg,.png,.gif" class="js-uploader__file-input uploader__file-input">' +
            ...
            function selectFilesHandler (e) {
                ...
                if (!state.isUploading) {
                    ...
                    var files = e.target.files || e.originalEvent.dataTransfer.files || e.originalEvent.dataTransfer.getData;
